...
<%
 ...
 <% if("非定向".equals(st.getS_stu_ffb()))
  ...
  <tr>
	...
	{
	%>
      <input name="s_stu_jy" type="radio" value="1" checked="checked" />就业
	  <input type="radio" name="s_stu_jy" value="0" />待业
      <%
	}
	else
	{
...
<input type="radio" name="s_stu_jy" value="1" />就业
<input type="radio" name="s_stu_jy" value="0" checked="checked" />待业
<%
	}
	%></td>
