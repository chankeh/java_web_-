...
<body>
<form name="zgform" action="stfind.jsp" method="post" onsubmit="javascript:return check();">
<table width="778" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#9EC3F2" style="font-size:12px">
  <!--DWLayoutTable-->
  <tr>
    <td height="25" colspan="6" align="left" valign="middle" background="img/bg_titlebarr.gif"><span class="STYLE1">学生基本信息查询&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>学生姓名：
  ...
  <tr>
    ...
    <td width="122" align="center" valign="middle" bgcolor="#F9FCFF">性别</td>
    <td width="156" align="center" valign="middle" bgcolor="#F9FCFF" class="STYLE4">身份证号</td>
  ...
  <tr>
    ...
    <td align="center" valign="middle" bgcolor="#F9FCFF"><span class="STYLE4"><a href="dispst.jsp?sid=<%=st.getS_stu_dabh()%>">查看</a></span></td>
  </tr>
  <%
  }
