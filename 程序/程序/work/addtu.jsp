...
<form name="opform" method="post" action="tuop.jsp" onsubmit="javascript:return check();">
  ...
  <tr>
    ...
    <td width="551" align="left" valign="middle" bgcolor="#F9FCFF"><input name="s_tu_name" type="text" id="s_tu_name" />  </td>
    </tr>
  
  <tr>
    <td height="25" align="center" valign="middle" bgcolor="#F9FCFF">电话</td>
    <td align="left" valign="middle" bgcolor="#F9FCFF"><input name="s_tu_dh" type="text" id="s_tu_dh" maxlength="18" /></td>
  </tr>
  <tr>
    <td height="25" align="center" valign="middle" bgcolor="#F9FCFF">地址</td>
    <td align="left" valign="middle" bgcolor="#F9FCFF"><input name="s_tu_dz" type="text" id="s_tu_dz" maxlength="18" /></td>
  </tr>
  <tr>
    <td height="25" align="center" valign="middle" bgcolor="#F9FCFF"><div align="center">所在院校</div></td>
    <td align="left" valign="middle" bgcolor="#F9FCFF"><input name="s_tu_yx" type="text" id="s_tu_yx" maxlength="18" />  </td>
    </tr>
</table>
