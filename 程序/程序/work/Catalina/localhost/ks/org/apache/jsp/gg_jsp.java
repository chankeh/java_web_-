...
if("save".equals(op)){
	...
	gm.setGg(ggnr,fbsj);
      ...
      out.write("  <table width=\"585\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border:1px solid #CCCCCC\" style=\"font-size:12px\">\r\n");
      ...
      out.write("\r\n");
      out.write("      <tr>\r\n");
      out.write("        <td height=\"19\" align=\"left\" valign=\"top\">状态:\r\n");
      out.write("          <input name=\"ggnr\" type=\"text\" value=\"");
      out.print(gg.getGgnr());
      out.write("\" size=\"10\" />\r\n");
      out.write("        <input name=\"fbsj\" type=\"hidden\" value=\"");
      out.print(DateFormate.getDateTime() );
      out.write("\" /><input name=\"op\" type=\"hidden\" value=\"save\" />\r\n");
      out.write("        （0.为停止考试期 1.为可以考试期）\r\n");
      out.write("        <input type=\"submit\" name=\"Submit\" value=\"设定状态\" /></td>\r\n");
      out.write("      </tr>\r\n");
      out.write("      \r\n");
      out.write("      <tr>\r\n");
