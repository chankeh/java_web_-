...
if(sysList.get(5).toString().trim().equals("open")){ 
      ...
      out.write("\t\t\t<SPAN class=TAG>搜索信息</SPAN> \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t  </TD>\r\n");
      out.write("\t\t</TR>\r\n");
      out.write("\t\t<TR>\r\n");
      ...
      out.print(basePath );
      out.write("sinfo.jsp\" name=form1 method=post onsubmit=\"return check()\">\r\n");
      out.write("      <TABLE class=xsnr id=tb1_nr1  cellSpacing=0 cellPadding=0 width=\"100%\" border=0>\r\n");
      out.write("                    <TBODY>\r\n");
      out.write("          <TR>\r\n");
      out.write("          <TD width=35% align=right>房屋户型：</td>\r\n");
      out.write("\t\t  <td><input type=text name=type size=30></TD>\r\n");
      out.write("\t\t</TR>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<TR>\r\n");
      out.write("          <TD  align=right>搜索类型：</td>\r\n");
      out.write("\t\t  <td><input type=radio name=ss value=\"出租\" checked> 出租 <input type=radio name=ss value=\"求租\"> 求租\r\n");
      out.write("\t\t   <input type=radio name=ss value=\"出售\"> 出售 <input type=radio name=ss value=\"求购\"> 求购</TD>\r\n");
      out.write("\t\t</TR>\r\n");
      out.write("\t\t<TR>\r\n");
      out.write("          <TD  align=center colspan=2><input type=submit value=\"搜索\">\r\n");
      out.write("\t\t   </TD>\r\n");
      out.write("\t\t</TR>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t</TBODY>\r\n");
