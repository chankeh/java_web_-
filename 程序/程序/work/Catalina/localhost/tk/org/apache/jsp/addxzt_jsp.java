...
public final class addxzt_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String boardid;
      ...
      out.write("\t}\r\n");
      out.write("\tform.action = \"sql.jsp?p=2\";\r\n");
      ...
      out.write("\t<tr>\r\n");
      out.write("\t  <td width=\"100%\" height=\"20\" class=\"a01\"><strong><font color=\"#FF0000\"><strong><font color=\"#FF0000\">::</font></strong>选择题录入<strong><font color=\"#FF0000\">::</font></strong></font></strong></td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>注意：</td>\r\n");
      out.write("\t\t\t\t<td>在录入选择项时用'()'括起，如果某项是正确答案在后面加上.Y 例如：<br>中国的首都是：<br>(A.北京.Y)<br>(B.天津)<br>(C.上海)<br>(D.重庆)</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
