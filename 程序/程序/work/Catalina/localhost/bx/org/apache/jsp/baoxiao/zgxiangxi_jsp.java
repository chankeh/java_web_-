...
public final class zgxiangxi_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <tr>\r\n");
      out.write("    <td align=\"right\" class=\"lanse\"><a href=\"xsxiangxi.jsp\" class=\"lanse\">&gt;&gt; 学生报销信息查询</a></td>\r\n");
      out.write("  </tr>\r\n");
      out.write("</table>\r\n");
      ...
      out.write("</tr>\r\n");
      out.write("</table>\r\n");
      out.write("<table width=\"790\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\"><form name=\"form1\" method=\"post\" action=\"zgxiangxi.jsp\">\r\n");
      out.write("  <tr>\r\n");
      out.write("    <td width=\"200\" height=\"42\" class=\"huanying1\">&nbsp;</td>\r\n");
      out.write("    <td width=\"100\" align=\"center\" class=\"lanse\">报销内容</td>\r\n");
      ...
      out.write("<table width=\"790\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n");
      out.write("  <form name=\"form２\" method=\"post\" action=\"zgxiangxi.jsp\">\r\n");
      out.write("    <tr>\r\n");
      out.write("      <td width=\"200\" height=\"42\" class=\"huanying1\">&nbsp;</td>\r\n");
      out.write("      <td width=\"100\" align=\"center\" class=\"lanse\">报销时间</td>\r\n");
      out.write("      <td width=\"190\" align=\"center\" class=\"huanying1\">\r\n");
      out.write("        <input name=\"dates\" type=\"text\" class=\"zhengwen\"></td>\r\n");
      out.write("      <td width=\"100\" align=\"center\" class=\"huanying1\"><input name=\"Submit2\" type=\"submit\" class=\"lanse\" value=\"查询\"></td>\r\n");
      out.write("      <td width=\"208\" class=\"huanying1\">&nbsp;</td>\r\n");
      out.write("    </tr>\r\n");
      out.write("  </form>\r\n");
      out.write("</table>\r\n");
	...
	try{
		...
		coursedate=request.getParameter("dates"); 

		if(coursename!=null&&!coursename.equals("")){
			if(coursedate!=null&&!coursedate.equals("")){
			sql="select * from t_bx_employee where bxname like '%"+coursename+"%' and bxdate like '%"+coursedate+"%' ";
			}
			else{
			sql="select * from t_bx_employee where bxname like '%"+coursename+"%' ";
			}
		}
		else{
		if(coursedate!=null&&!coursedate.equals("")){
			sql="select * from t_bx_employee where bxdate like '%"+coursedate+"%' ";
			}
			else{
			sql="";
			}
...
//当j大于1时，就会显示“第一页”、“上一页”字样 
	...
	{ 
      ...
      out.write("\r\n");
      out.write("    <a href=\"zgxiangxi.jsp?pageNo=1&name=");
      ...
      out.write("\r\n");
      out.write("    | <a href=\"zgxiangxi.jsp?pageNo=");
      out.print(ssTmp);
      out.write("&name=");
      out.print(coursename);
...
//----快速定位结束------------------------------------
	...
	{ 
      ...
      out.write("&name=");
      out.print(coursename);
      out.write("\" class=\"lanse\"> 下一页</a> | <a href=\"zgxiangxi.jsp?pageNo=");
      out.print(mtotal);
      out.write("&name=");
      out.print(coursename);
