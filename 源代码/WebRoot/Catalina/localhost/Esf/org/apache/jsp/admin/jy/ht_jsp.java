...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
      ...
      out.write("      <td  align=\"center\">合同项目</td>\r\n");
	...
	List pagelist3=hsb.getAllWord(); 
      ...
      out.print(basePath );
      out.write("HouseServlet?method=delWord&id=");
      ...
      out.print(basePath );
      out.write("HouseServlet?method=addWord\" method=post name=form1 onsubmit=\"return check()\">\r\n");
