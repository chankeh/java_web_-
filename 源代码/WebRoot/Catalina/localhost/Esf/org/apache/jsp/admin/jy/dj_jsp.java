...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
      ...
      out.write("      <td  align=\"center\">定金项目</td>\r\n");
	...
	List pagelist3=hsb.getAllDj();
      ...
      out.print(basePath );
      out.write("HouseServlet?method=delDJ&id=");
      ...
      out.print(basePath );
      out.write("HouseServlet?method=addDJ\" method=post name=form1 onsubmit=\"return check()\">\r\n");
