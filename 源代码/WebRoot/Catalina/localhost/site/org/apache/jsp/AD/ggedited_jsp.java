...
public final class ggedited_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(dz==null){ response.sendRedirect("gggl.jsp"); }
String sql="update ggt set dz='"+dz+"',ggurl='"+url+"',ggtext='"+text+"' where id="+id;
 stat.executeUpdate(sql);
   out.print("操作成功s");
  session.setAttribute("dz","更新广告操作");
session.setAttribute("buffer","成功！");
