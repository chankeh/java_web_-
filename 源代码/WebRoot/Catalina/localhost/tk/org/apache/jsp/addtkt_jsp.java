...
public final class addtkt_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String boardid;
      ...
      out.write("\tstr = '';\r\n");
      out.write("\tif(form.tkttm.value=='') str += \"题目\\n\";\r\n");
      out.write("\tif(form.tks.value=='') str += \"填空数\\n\";\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\tform.action = \"sql.jsp?p=1\";\r\n");
      ...
      out.write("\t<tr>\r\n");
      out.write("\t  <td width=\"100%\" height=\"20\" class=\"a01\"><strong><font color=\"#FF0000\"><strong><font color=\"#FF0000\">::</font></strong>填空题录入<strong><font color=\"#FF0000\">::</font></strong></font></strong></td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      ...
      out.write("\t\t\t\t<td><TEXTAREA NAME=\"tkttm\" ROWS=\"5\" cols=\"50\"></TEXTAREA></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>注意：</td>\r\n");
      out.write("\t\t\t\t<td>在录入时答案用'()'括起来！比如：中国的首都是(北京)</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td >填空数：</td>\r\n");
      out.write("\t\t\t\t<td><INPUT TYPE=\"text\" NAME=\"tks\">*请输入数字</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
