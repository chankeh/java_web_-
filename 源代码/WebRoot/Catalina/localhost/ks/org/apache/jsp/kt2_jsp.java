...
public final class kt2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
aop.exeks(sid,oldrowid,answer);
  ...
  //kt=(ktxx)ktop.getKtxxbyid(id);
      ...
      out.write("\r\n");
      out.write("<body>\r\n");
      out.write("<form name=\"opform\" method=\"post\" action=\"kt2.jsp?op=next\" onsubmit=\"javascript:return check();\">\r\n");
      ...
      out.write("  <tr>\r\n");
      out.write("    <td height=\"25\" colspan=\"2\" align=\"left\" valign=\"middle\" background=\"img/bg_titlebarr.gif\"><span class=\"STYLE1\">&nbsp;改错题（<span class=\"STYLE5\">请将正确的内容填写到答案中</span>） 此题分值：");
      out.print(an.getFs());
      out.write(" </span></td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  \r\n");
