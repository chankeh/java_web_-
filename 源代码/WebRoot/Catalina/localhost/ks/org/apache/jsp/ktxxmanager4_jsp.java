...
public final class ktxxmanager4_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  fs=ktop.getsumbylx("4");
  al=ktop.getKtxxbylx("4");
  ...
  ktxx kt=new ktxx();
      ...
      out.write("  <tr>\r\n");
      out.write("    <td height=\"25\" colspan=\"5\" align=\"left\" valign=\"middle\" background=\"img/bg_titlebarr.gif\"><span class=\"STYLE1\">选择题库[<a href=\"addktxx4.jsp\">新增考题</a>]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本题分数合计：");
      out.print(fs);
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  <tr>\r\n");
  ...
  for(int i=0;i<al.size();i++){
	...
	if(question.length()>20){
	 ...
	 out.print(question);
      ...
      out.print(kt.getFs() );
      out.write("</span></td>\r\n");
      out.write("    <td align=\"center\" valign=\"middle\" bgcolor=\"#F9FCFF\"><span class=\"STYLE4\"><a href=\"ktxxop.jsp?op=del&lx=4&id=");
      out.print(kt.getId());
