...
<table width="1024" border="0" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr>
    <td height="80" colspan="3" valign="top" background="img/logo.gif"><!--DWLayoutEmptyCell-->&nbsp;</td>
  </tr>
  <tr>
    ...
    <td width="443" align="left" valign="bottom" background="img/bg_titlebarr.gif" class="STYLE1" style="border-bottom:1px solid #9EC3F2" onclick="javasciprt:modipass();" style="cursor:hand;">[修改个人密码] <span onclick="javasciprt:exit();" style="cursor:hand;">[退出系统]</span></td>
  </tr>
</table>
</body>
</html>
